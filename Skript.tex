...
\begin{document}
    ...
    \begin{beispiel}[Integral von Potenzreihen]
        ...
        \begin{align*}
            ...
            \intertext{Wir wissen $\forall\delta > 0$ klein genug (das heißt konkrete $\delta < R$) konvergiert $f_n$ gleichmäßig gegen $f$ auf dem Intervall $\interv{x_0-R+\delta, x_0+R-\delta}$. Dann gilt nach Satz~\ref{satz:gleichm-int} für $x\in\interv{x_0-R+\delta, x_0+R-\delta}$ fest}
