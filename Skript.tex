...
\begin{document}
    ...
    \begin{satz} % Satz 19
        ...
        \begin{proof}
            ...
            \begin{enumerate}[label=(\roman*)]
                ...
                \begin{align*}
                    V \cap A^{C} &= V\cap \pair{X\exclude A} = \emptyset\tag{(1)}
                    ...
                    V \cap\pair{\partial A \cup A^{C}} &= \emptyset\\
                    \equivalent V \subseteq A \exclude \partial A\\
                    \impl A\exclude \partial A \text{ ist offen }
                \end{align*}
                \item $A^{C} = X \exclude A$. Aus der Definition des Randes folgt $\partial A = \partial A^{C}$. Nach (i) gilt dann
                \begin{align*}
                    A^{C} \exclude \partial A = A^{C} \exclude \partial A^{C} \text{ ist offen }\\
                    \equivalent \pair{A^{C} \exclude \partial A}^{C} \text{ ist abgeschlossen }\\
                    \equivalent \pair{A^{C} \exclude \partial A}^{C} &= X\exclude\pair{A^{C} \exclude \partial A}\\
                    &= X\exclude A^{C} \cup \partial A = A\cup \partial A \text{ ist abgeschlossen }
                \end{align*}
                \item
                \begin{align*}
                    \partial A &= \pair{A\cup \partial A} \cap \pair{A^C \cup \partial A}\\
                    &= \pair{A \cup \partial A} \cap \pair{A^C \cup \partial A^{C}} \text{ ist abgeschlossen}
                \end{align*}
            \end{enumerate}
        \end{proof}
    \end{satz}

    \begin{definition}[Innere und Abschluss]
        ...
        \begin{enumerate}[label=(\roman*)]
            ...
            Das Innere von $A = \overset{\circ}{A} \coloneqq \bigcup_{\sigma\in U\of{A}} =$ Vereinigung aller offenen Teilmengen von $A$
    ...
    \begin{bemerkung}
        $\overset{\circ}{A} =$ größte offene Teilmenge von $A$ und $\overline{A} = $ kleinste abgeschlossene Menge, die $A$ enthält.
    \end{bemerkung}

    \begin{satz} % Satz 21
        $\overset{\circ}{A} = A \exclude \partial A$ und $\overline{A} = A \cup \partial A$.
        \begin{proof}
            \textsc{Teil 1}: Nach Satz~\ref{satz:top-rand} ist $A\exclude \partial A$ offen und $A \exclude \partial A \subseteq A$. Damit folgt $A \exclude \partial A \subseteq \overset{\circ}{A}$.\\
            Damit ist noch zu zeigen, dass $\overset{\circ}{A} \subseteq A \exclude \partial A$. Ist $U\subseteq A$ offen
            \begin{align*}
                \impl U\cap A^{C} &= \emptyset
                \impl U \cap \partial A &= \emptyset
            \end{align*}
            Falls nicht $\exists y \in U \cap \partial A$, dann folgt $U\cap A^{C} \neq \emptyset$. Das ergibt einen Widerspruch.\\
            ...
            \begin{align*}
                ...
                \impl \overset{\circ}{A} \subseteq A \exclude \partial A\\
                \impl A \exclude \partial A = \overset{\circ}{A}
            \end{align*}
            \textsc{Teil 2}: Behauptung: Aus $B\subseteq X$ ist abgeschlossen und $A \subseteq B$ folgt $\partial A \subseteq B$. Angenommen die Behauptung ist falsch. Dann würde gelten $B^{C} \cap \partial A \neq \emptyset$.\\
            $x\in \partial A \cap B^{C}$. $B^{C}$ ist offene Umgebung von $x$. Nach Definition von $\partial A$ ist $A\cap B^{C}\neq \emptyset$. Das heißt $A \subseteq B$. (Widerspruch).\\
    ...
    \begin{bemerkung}
        \begin{align*}
            A &\subseteq M \text{ beschränkt }\\
            \equivalent \exists x\in M, r > 0\colon A &\subseteq B_{r}\of{x}
        \end{align*}
