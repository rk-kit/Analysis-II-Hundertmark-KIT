...
\begin{document}
    ...
    \begin{definition}
        ...
        $f\of{\pair{x_{j-1}, x_j}}$ können zu stetigen Funktionen auf $I_j=\interv{x_{j-1}, x_j}$ fortgesetzt werden. Wir nennen diese Klasse von Funktionen $PC\of{I}$\footnote{Piecewise continuos function in $I$}.
    \end{definition}
    ...
    \begin{bemerkung}
        Insbesondere erfüllt $PC\of{I}$ die Bedingungen a) und b) aus Satz~\ref{satz:temp-18}.
    \end{bemerkung}
    ...
    \begin{proof}
        ...
        \begin{align*}
            ...
            \intertext{Da $\varphi$ eine Treppenfunktion ist, ist $\varphi\in PC\of{I}\subseteq R\of{I}$. Also existiert eine Folge $(z_n)_n$ von Zerlegungen von $I$ mit}
            ...
            \impl f&\in R\of{I}\qedhere
        \end{align*}
    \end{proof}

    \begin{bemerkung}
        Welche $f\in B\of{I}$ sind genau Riemann-integrierbar?
    \end{bemerkung}
    ...
    \begin{genv}[Lebesgue'sches Integrabilitätskriterium]
        $R\of{I} = \set{f\in B\of{I}: f \text{ ist fast überfall stetig auf } I}$
    \end{genv}
    ...
    \begin{bemerkung}
        ...
        Ist $f\in PC\of{I}$ so ist die Menge der Unstetigkeitsstellen endlich.
    \end{bemerkung}
    ...
    \begin{lemma} % Lemma 21
        \label{lemma:temp-21}
        Seien $f,g\in R\of{I}$ und gebe es eine Menge $G\subseteq I$ welche in $I$ dicht liegt und für die $f(x) = g(x)~\fa x\in G$ gilt. Dann folgt $\int_{a}^{b} f(x)\dif x = \int_{a}^{b} g(x)\dif x$
    \end{lemma}

    \subsection{Mittelwertsätze der Integralrechnung}

    \begin{definition}
        Sei $f\in R\of{I}$, $I=\interv{a,b}$. Dann ist
        \begin{align*}
    ...
    \begin{satz}
        Es sei $I=\interv{a,b}$, $f\in C\of{I}$. Dann gilt
        \begin{align*}
